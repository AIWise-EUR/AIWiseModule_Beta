(() => {
  ...
  const routes = {
    profiler: { from: 'Course Profiler', to: 'Beta', type: 'submission', lane: 'profiler' },
    ...
    'rev-profiler': { from: 'Beta', to: 'Course Profiler', type: 'revision', lane: 'profiler' },
